							...
							<div class="modal-body mb-1">
								<div class="md-form form-sm mb-5">
									 <input type="text"
										...
										data-error="wrong" data-success="right" for="modalLRInput10">Your Username</label>
								</div>
							...
							<div class="modal-body">
								<div class="md-form form-sm mb-5">
									<input type="username"
										...
										class="form-control form-control-sm validate"> <label
										data-error="wrong" data-success="right" for="modalLRInput12">Your username</label>
								</div>
								<div class="md-form form-sm mb-5">
									<input type="password"
								...
								<div class="md-form form-sm mb-4">
									<input type="password"
										id="modalLRInput14"
										class="form-control form-control-sm validate"> <label
										data-error="wrong" data-success="right" for="modalLRInput14">Repeat password</label>
								</div>
