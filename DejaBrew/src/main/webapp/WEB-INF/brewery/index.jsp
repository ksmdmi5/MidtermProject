...
<body>
	...
	<h3> We Encourage Our Visitors to Contribute and Add to Our List</h3>
		...
		<div class="masonry">
				...
				<div class="masonry-item">
					<div class="masonry-content">
						<div class="card" style="width: 250px">
								...
								<img class="card-img-top" src="${brew.logourl}" style="width: 250px" alt=" Cardimage">
								<div class="card-body">
			...
			<div class="card" style="width: 250px">
				<img class="card-img-top"
					src="/image/taps.jpg" alt="Card image">
				<div class="card-body">
