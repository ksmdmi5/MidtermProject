...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (3, 'paulxl', 'paulxl', true, 'ROLE_ADMIN');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (4, 'carlmax', 'butitworks', true, 'ROLE_ADMIN');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (5, 'bautista', 'guamagain', true, 'ROLE_ADMIN');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (6, 'cody2', 'ilikeitcold', true, 'ROLE_ADMIN');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (7, 'sarahLittle', 'sarahLittle', true, 'ROLE_USER');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (8, 'crazyTed', 'crazyTed', true, 'ROLE_USER');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`) VALUES (9, 'marthaB', 'marthaB', true, 'ROLE_USER');
...
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (2, 2, 2, 'Avery Brewing Company', 1, 'Established in 1993, Avery Brewing Co. is a family owned and operated micro-brewery dedicated to brewing the finest quality English and Belgian style ales.. From humble beginnings, brewing 800 barrels of three different beers in 1994, we have progressed to brewing 13,000 barrels of twenty different beers in 2007. We attribute this success to beer drinkers gravitating to beers with more interesting flavor profiles. The unique flavor complexity of Avery beers occurs through a combination of sparing no expense with regard to ingredients and our hopping methods. Sparing no expense means using lots of specialty malts, imported hops, such as Styrian Goldings, and imported Belgian candy sugar.', 'http://www.averybrewing.com/', 1, 'https://i.vimeocdn.com/portrait/6956905_600x600.webp');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (3, 3, 3, 'Backcountry Brewery', 1, '', '', 0, 'https://3.bp.blogspot.com/-vs2h83X2Yzc/WRuad8lGuCI/AAAAAAAAD8Y/n_K4_H13ZmEeX__3ffemqNh9E0m491TiACLcB/s1600/14100358_10153715979067233_4229655348491101355_n.jpg');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (5, 5, 4, 'Boulder Beer Company', 1, '', 'http://boulderbeer.com/', 0, 'https://scontent.fapa1-1.fna.fbcdn.net/v/t1.0-9/12115637_10153418877147663_5824627673618583945_n.jpg?_nc_cat=103&_nc_oc=AQl6vCvnfSn7ODSLf1ewe_gGhnKXLciNSnfFqlij6p8eiE7a-Mtq4eGO_FuuH9N6hzw&_nc_ht=scontent.fapa1-1.fna&oh=319036c0702bd54394a9c970d756b016&oe=5E3B7F9A');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (6, 6, 5, 'Breckenridge Brewery', 1, '', 'http://www.breckbrew.com/', 1, 'https://www.breckbrew.com/_stay_out/images/logo.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (7, 7, 6, 'Bristol Brewing', 1, '', '', 1, 'http://www.bristolbrewing.com/wp-content/uploads/2018/06/Color-Circular-BBC-logo2.png');
...
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (13, 13, 3, 'Crested Butte Brewery &  Pub', 1, '', '', 1, 'http://irwinbrewingco.com/wp-content/uploads/2017/07/IBC-FUll.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (14, 14, 3, 'Denver ChopHouse and Brewery', 1, '', '', 0, 'http://www.denverbrewz.com/sites/default/files/styles/square_300/public/2018-02/_denverchophouse-logo.jpg?itok=9iaBwlb4');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (15, 15, 4, 'Dillon Dam Brewery', 1, '', '', 0, 'https://www.dambrewery.com/wp-content/themes/dam/images/logo-2x.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (17, 17, 4, 'Dostal Alley', 1, '', '', 1, 'http://dostalalley.com/wp-content/uploads/2012/04/dostal-logo3.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (18, 18, 5, 'Estes Park Brewery', 1, 'The original Brewing equipment which consisted of a 4 1/4  Barrel Brewhouse was moved to Estes. For the first summer the Event Center kept the main floor as a stage and dance floor. For the first summer we offered four beers:  Estes Park Porter, Estes Park Renegade, Longs Peak Raspberry Wheat and Estes Park Pale Ale.  In the fall of 1994, Gordon Knight decided to sell his half of the business. When Gordon left, Eric Bratrud took over as the head Brewer. The Brewery also expanded to a 14 BBL Brewhouse and moved out onto the main floor where is now located. In 1995 we started packaging our beers in 12 oz bottles, which expanded our market. By this time we had added a number of beers including Trail Ridge Red, Estes Park Gold, Stinger Wild Honey Wheat and Samson Stout. 1995 was also the first year of the Best of the West Brewfest held in the Brewery parking lot. Since \'95 we\'ve continued to evolve both in our restaurant and with our brewing operations. In 2003 Tyler Lemirande and Eric Bratrud took over as owners.', 'http://www.epbrewery.net/', 1, 'https://beerpulse.com/wp-content/uploads/2012/11/Estes-Park-Brewery-logo-BW-e1353888216375-200x200.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (19, 19, 5, 'Flying Dog Brewery', 1, '', 'http://www.flyingdogales.com/', 0, 'https://www.flyingdog.com/static/images/global/fd-logo-no-text.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (20, 20, 6, 'Fort Collins Brewery', 1, '', 'http://www.fortcollinsbrewery.com', 1, 'https://upload.wikimedia.org/wikipedia/en/1/1e/The_Fort_Collins_Brewery_Logo.jpg');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (21, 21, 6, 'Glenwood Canyon Brewing Company', 1, '', '', 0, 'https://www.glenwoodcanyon.com/wp-content/uploads/2017/02/gcbc_logohoriz.png');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (22, 22, 6, 'Golden City Brewery', 1, '', '', 1, 'https://uploads-ssl.webflow.com/5bb9061682df353358b4052b/5bb906dc24337c305f2e93f9_GCB%20logo1Small-p-500.png');
...
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (25, 25, 4, 'Great Divide Brewing', 1, 'Since 1994, Great Divide has brewed the most balanced yet assertive and flavorful beers possible.  This commitment has not gone unrewarded  Great Divide has racked up 12 Great American Beer Festival Medals and four World Beer Cup awards, and was recently honored as the 23rd Best Brewer in the World in Ratebeer.com\'s World\'s Top 100 Brewers, (2007). See for yourself what the excitement is about  and then introduce your friends to the new frontier of beer. --http://www.greatdivide.com', 'http://www.greatdivide.com/', 1, 'https://greatdivide.com/wp-content/uploads/2016/06/great-divide-logo.jpg');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (29, 29, 4, 'Hops Grillhouse & Brewery - Cherry Creek', 1, '', '', 1, 'https://static1.squarespace.com/static/584b266bff7c50e17bb8a31a/t/5890a8ec59cc68806c8e335c/1565300439301/?format=1500w');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (32, 32, 4, 'Left Hand Brewing Company', 1, '', 'http://www.lefthandbrewing.com/', 1, 'https://upload.wikimedia.org/wikipedia/commons/f/f5/Left_Hand_Logo.jpg');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (33, 33, 6, 'Mill Steakhouse', 1, '', '', 1, 'https://s3-media2.fl.yelpcdn.com/bphoto/-2xbWBnbpX2y6GcqvVE6Ew/l.jpg');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (34, 34, 3, 'Mountain Sun Pub & Brewery', 1, '', '', 1, 'https://pbs.twimg.com/profile_images/204987266/mountain_sun_logo_400x400.jpg');
INSERT INTO `brewery` (`id`, `address_id`, `createdby_user`, `name`, `active`, `description`, `url`, `menu`, `logourl`) VALUES (36, 36, 3, 'New Belgium Brewing', 1, 'We\'ll set the scene: 1989. Belgium. Boy on bike. (OK, make that a young man of 32). As our aspiring young homebrewer rides his mountain bike with fat tires through European villages famous for beer, New Belgium Brewing Company was but a glimmer in his eye. Or basement. For Jeff Lebesch would return to Fort Collins with a handful of ingredients and an imagination full of recipes. And then there was beer. Jeff\'s first two basement-brewed creations? A brown dubbel with earthy undertones named Abbey and a remarkably well-balanced amber he named Fat Tire. To say the rest was history would be to overlook his wife\'s involvement. Kim Jordan was New Belgium\'s first bottler, sales rep, distributor, marketer and financial planner. And now, she\'s our CEO.', 'http://www.newbelgium.com/', 1, 'https://upload.wikimedia.org/wikipedia/en/9/94/New_Belgium_Brewing_Company_logo.gif');
...
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (2, 3, 3, 3, 'decent beer, food o.k., high prices', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (3, 4, 3, 5, 'cheap good beer', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (4, 5, 5, 4, 'nice place to hang out and have a beer, not too loud, good food', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (5, 6, 6, 2, 'way to expensive for what you get', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (6, 7, 7, 5, 'fun place to hang out and meet friends', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (7, 7, 1, 4, 'great place to meet friends and hang out  and they got good beer', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (8, 7, 2, 5, 'a bit expensive but otherwise great brewery', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (9, 8, 3, 5, 'lots of locals, cheap prices, clean', NULL);
INSERT INTO `review` (`id`, `user_id`, `brewery_id`, `rating`, `details`, `date_reviewed`) VALUES (10, 9, 3, 4, 'food is ok, good beer', NULL);
